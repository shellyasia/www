...
Designed for retrofitting into standard electrical wall boxes, behind power outlets, light switches, or other space-constrained areas, it offers seamless integration into existing installations.

It includes an embedded web interface for configuration, monitoring, and real-time control of the device.

## Main Features

- **Wi-Fi Connectivity:** Connects to your home Wi-Fi network (802.11 b/g/n) for remote monitoring and control.
...
- **Compact Design:** Small form factor ideal for installation in standard electrical enclosures, behind sockets, or in tight spaces.
- **Remote Control:** Enables remote operation of appliances via mobile apps, web browsers, or home automation platforms.
- **Local and Cloud Operation:** Supports both local network control and cloud-based management.
- **Improved Processor & Memory:** Enhanced hardware delivers faster response times and better multitasking capabilities.
- **Remote Access:** Full remote access from anywhere with internet connectivity.
- **Embedded Web Interface:** Built-in interface for setup, monitoring, and configuration.
- **Wireless Connectivity:** Supports Wi-Fi (802.11 b/g/n) and Bluetooth 4.2 with defined indoor/outdoor range.
- **BLE Gateway:** Acts as a bridge between Shelly BLU devices and the broader Shelly ecosystem by relaying Bluetooth signals to the cloud or local devices.
...
- **KNX Support:** Communicates via KNXnet/IP protocol for integration into KNX-based building automation systems.
- **Scheduling:** Schedule complex operations based on date, time of day, weekdays, hours, minutes, and seconds.
...
- **Power Monitoring:** Track real-time energy usage to identify inefficiencies and promote conservation.
- **Home Automation:** Integrate into smart home ecosystems to create custom scenes, routines, and automations.
- **Energy Efficiency:** Use power data to detect high-consumption devices and optimize energy use.
- **Remote Monitoring:** Monitor and control devices even when away from home using internet-connected access.
...
> **Note:** The LED states are prioritized in order. Each subsequent state overrides the previous one.
...
- [This device API documentation](https://shelly-api-docs.shelly.cloud/gen2/Devices/Gen3/Shelly1PMG3)
